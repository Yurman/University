...
public class GroupDaoImpl implements CrudDao<Group> {
	...
	// DepartmentDaoImpl department = new DepartmentDaoImpl();
	...
	try {
		...
		// group.setDepartment(department.getById(result.getInt(4)));
	    }
	...
	try {
	    ...
	    statement.setInt(4, group.getDepartment().hashCode()); // ??
	...
	try {
	    ...
	    statement.setInt(3, group.getDepartment().hashCode()); // ??
